...
class AccoladeUnitTests(unittest.TestCase):
    ...
    def test_create_accolade(self):
        from App.controllers.accolade_controller import create_accolade
    ...
    def test_update_accolade_description(self):
        from App.controllers.accolade_controller import create_accolade, update_accolade
    ...
    def test_update_accolade_staff_id(self):
        from App.controllers.accolade_controller import create_accolade, update_accolade
        from App.models import Accolade, Staff
    ...
    def test_delete_accolade(self):
        from App.controllers.accolade_controller import create_accolade, delete_accolade, search_accolades
    ...
    def test_assign_accolade_to_student(self):
        ...
        from App.models import AccoladeHistory, Accolade, Student
    ...
    def test_remove_accolade_from_student(self):
        from App.controllers.accolade_controller import create_accolade, assign_accolade_to_student, remove_accolade_from_student
        from App.models import AccoladeHistory, Accolade, Student
    ...
    def test_drop_accolade_table(self):
        from App.controllers.accolade_controller import create_accolade, drop_accolade_table, search_accolades
